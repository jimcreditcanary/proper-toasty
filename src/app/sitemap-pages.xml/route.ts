...
export async function GET(): Promise<Response> {
  ...
  const entries: SitemapUrlEntry[] = [
    ...
    {
      loc: `${SITE_URL}/research/epc-index-2026-q2`,
      lastmod: now,
      changefreq: "monthly",
      priority: 0.8,
    },
    {
      loc: `${SITE_URL}/research/most-efficient-uk-borough-tower-hamlets`,
      lastmod: now,
      changefreq: "monthly",
      priority: 0.7,
    },
    {
      loc: `${SITE_URL}/research/rural-wales-energy-waste-100m`,
      lastmod: now,
      changefreq: "monthly",
      priority: 0.7,
    },
    {
      loc: `${SITE_URL}/research/burnley-uk-biggest-epc-improver`,
      lastmod: now,
      changefreq: "monthly",
      priority: 0.7,
    },
    {
      loc: `${SITE_URL}/research/uk-home-energy-savings-259-per-year`,
      lastmod: now,
      changefreq: "monthly",
      priority: 0.7,
    },
    {
      loc: `${SITE_URL}/research/uk-postcode-heating-cost-lottery`,
      lastmod: now,
      changefreq: "monthly",
      priority: 0.7,
    },
