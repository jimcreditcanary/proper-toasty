...
type SnapshotShape = {
  ...
  // renders the same focus the user actually ran. Optional — older
  // snapshots predate this and fall back to "all".
...
function SharedReportInner({ data }: { data: LoadReportResponse }) {
  ...
  const initialState: Partial<CheckWizardState> = {
    ...
    // focus + brand partner. Older snapshots without these fall back
    // to the generic all-focus report.
